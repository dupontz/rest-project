...
class Feira(models.Model):
    ...
    regiao5 = models.CharField(null=True, max_length=6, blank=True)
    regiao8 = models.CharField(null=True, max_length=7, blank=True)
    nome_feira = models.CharField(null=True, max_length=50, blank=True)
    registro = models.CharField(null=True, max_length=6, blank=True)
